...
export default function Index() {
  ...
  const LetterRack = () => {
    ...
    return (
      <div
        id="rack"
        ref={setNodeRef}
        className={`sticky bottom-0 z-10 bg-inherit border-t-2 px-4 py-3  border-pinky dark:border-ivory`}
        style={{
          display: "grid",
  ...
  const DumpArea = () => {
    ...
    return (
      <div
        ref={setNodeRef}
        className={`sticky bottom-0 mt-2 px-4 py-2 rounded-full border-2 border-dashed text-sm font-medium z-10 transition-all border-cocoa dark:border-pinky text-cocoa dark:text-pinky ${
  ...
  const Cell = ({
    ...
    return (
      <div
        ref={setNodeRef}
        className={`w-10 h-10 flex items-center justify-center border border-pinky dark:border-ivory`}
        style={{
  ...
  return (
    <main
      className={`relative min-h-screen flex flex-col items-center justify-center px-4 transition-colors text-white dark:text-black bg-pinky dark:bg-cocoa`}
    >
      <button
      ...
      >
        <div
          className={`grid gap-1 border border-pinky dark:border-cocoa`}
          style={{
        ...
        <button
          ...
          className={`mt-4 bg-cocoa disabled:bg-brown-100 text-pinky disabled:text-gray dark:bg-pinky dark:text-cocoa dark:disabled:bg-pink-100 font-bold py-2 px-4 rounded-full shadow-lg hover:shadow-xl transition duration-300`}
        >
      ...
      <div className="mt-4 flex gap-2">
        <button
          ...
          className={`p-2 rounded-full transition-colors bg-pinky dark:bg-cocoa text-cocoa dark:text-pinky`}
